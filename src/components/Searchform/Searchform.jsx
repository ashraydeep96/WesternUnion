...
const Searchform = () => {
  ...
  useEffect(()=>{
    ...
    const handleSearch = (event) => {
      ...
      const newData = data
      .filter(x =>  x.mtcn === mtcn.toString() | x.direction === Direction.toString() | x.status === Status.toString() | x.fixedTransaction === Fixed.toString() | x.recordingCountry === Recording.toString() | x.payOutCountry === Payout.toString() | x.sendingSideCurrency === Currency.toString())
      console.log(newData)
      setSearchData(newData)
    };

  const countryNames = [...new Set(transactions.map(transactions => transactions.recordingCountry))].sort();
  const payoutcountryNames = [...new Set(transactions.map(transactions => transactions.payOutCountry))].sort();
  const currency = [...new Set(transactions.map(searchData => searchData.sendingSideCurrency))].sort();
  const fixed = [...new Set(transactions.map(transactions => transactions.fixedTransaction))].sort((a, b) => a - b);
  const direction = [...new Set(transactions.map(transactions => transactions.direction))].sort();
  const status = [...new Set(transactions.map(transactions => transactions.status))].sort();
                ...
                <div className="form-floating2">
                  ...
                  >
                    ...
                    {direction.map((direction, index) => (
                      <option key={index} value={direction} style={{color:'black'}}>
                        {direction}
                      </option>
                    ))}
                  </select>
                ...
                <div className="form-floating2">
                  ...
                  >
                    ...
                    {fixed.map((fixedTransaction, index) => (
                      <option key={index} value={fixedTransaction} style={{color:'black'}}>
                        {fixedTransaction}
                      </option>
                    ))}
                  </select>
                ...
                <div className="form-floating2">
                  ...
                  >
                    ...
                    {countryNames.map((recordingCountry, index) => (
                      <option key={index} value={recordingCountry} style={{color:'black'}}>
                        {recordingCountry}
                      </option>
                    ))}
                  </select>
                ...
                <div className="form-floating2">
                  ...
                  >
                    ...
                    {payoutcountryNames.map((payoutcountry, index) => (
                      <option key={index} value={payoutcountry} style={{color:'black'}}>
                        {payoutcountry}
                      </option>
                    ))}
                  </select>
                ...
                <div className="form-floating2">
                  ...
                  >
                    ...
                    {currency.map((currency, index) => (
                      <option key={index} value={currency} style={{color:'black'}}>
                        {currency}
                      </option>
                    ))}
                  </select>
